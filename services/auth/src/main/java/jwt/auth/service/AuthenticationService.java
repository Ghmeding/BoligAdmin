...
public class AuthenticationService {
    ...
    public User signUp(RegisterUserDto input){
        ...
        //TODO: Do checks here: valid email, email already taken, valid password
    ...
    public void verifyUser(VerifyUserDto input){
        ...
        if (optionalUser.isPresent()) {
            ...
            throw new RuntimeException("User not found"); // if the user is not present in the database
        }
    }
